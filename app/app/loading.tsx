    ...
    <div className="mx-auto max-w-6xl">
      <Card className="rounded-2xl">
        <CardHeader className="pb-3">
          <CardTitle className="text-base">{t("app.loading.title")}</CardTitle>
          <p className="text-sm text-muted-foreground">{t("app.loading.subtitle")}</p>
        </CardHeader>
        ...
        <CardContent className="pt-0">
          <div className="space-y-4">
            ...
            <p className="text-xs text-muted-foreground">{t("app.loading.sessionHint")}</p>
          </div>
        </CardContent>
      </Card>
    </div>
