...
export function AccountSupportCards() {
  const { t } = useAppI18n();
      ...
      <Card className="rounded-2xl">
        ...
        <CardContent className="space-y-3">
          <div className="text-sm">
            ...
            <p className="text-xs text-muted-foreground">{t("app.account.help.workflowOverview")}</p>
          </div>
          ...
          <div className="text-sm">
            ...
            <p className="text-xs text-muted-foreground">{t("app.common.draftingSupport")}</p>
          </div>
