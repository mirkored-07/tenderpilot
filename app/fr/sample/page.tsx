...
export const metadata: Metadata = {
  title: "Exemple TenderPilot - AI Go/No-Go Decisions for Tenders & RFPs | Aperçu de l’analyse IA",
  description:
      ...
      <header className="sticky top-0 z-50 border-b border-white/5 bg-background/60 backdrop-blur-xl">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 md:h-16 md:px-6">
          <div className="flex items-center gap-4">
            <Link href="/fr" className="font-bold text-lg tracking-tight hover:opacity-80 transition-opacity">
              {nav.title}
            </Link>
          ...
          <div className="hidden md:flex items-center gap-3">
            <Button asChild variant="ghost" className="rounded-full hover:bg-white/5">
              <Link href="/fr"><ArrowLeft className="w-4 h-4 mr-2" /> {t.header.backToHome}</Link>
            </Button>
          ...
          <div className="flex items-center gap-2 md:hidden">
            <Button asChild variant="ghost" className="rounded-full h-9 w-9 p-0">
              <Link href="/fr"><ArrowLeft className="w-4 h-4" /></Link>
            </Button>
